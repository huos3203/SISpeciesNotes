...
extension UIView{
    ...
    var hiddenGuideItem:(UIButton)->()
    //
    public func addGuideFullScreen(backgroundImageView:UIImageView,leftItem:UIButton,rightItem:UIButton) ->(UIButton)->(){
        //
...
//        leftItem.addTarget(self, action: #selector(self.hiddenGuideItem(_:)), forControlEvents: .TouchDown)
        leftItem.addTarget(self, action: Selector("hiddenGuideItem:"), forControlEvents: .TouchUpInside)
