...
//画矩形
public func drawRectPath(frame:CGRect){
...
//画圆形:要画圆，我们需要传的rect参数必须是正方形哦！
 public func drawCiclePath(frame:CGRect){
...
public func drawOvalPath(frame:CGRect){
...
public func drawRoundRectPath(frame:CGRect){
...
public func drawARCPath(frame:CGRect){
